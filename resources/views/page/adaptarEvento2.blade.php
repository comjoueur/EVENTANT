...
@keyframes fadeIn {
  ...
  to {opacity:1 ;}
        ...
        <form action="{{route ('AdaptarEventostore2')}}" method="post" >
        {{csrf_field()}}
        <div>
            <div>
            <label>Nombre   </label>
        ...
        <button type="submit" class="popup" onclick="myFunction()"> Adaptar Evento<span class="popuptext" id="myPopup">Información Guardada</span></button>
